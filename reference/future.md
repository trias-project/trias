...
These sf objects contain future worldwide climate classifications for
different year intervals.

Future scenarios are dependent on several variables like pollution
levels. Currently the `future` datapackage contains the following
scenarios:
...
- `2001-2025-A1F1`: A1FI scenario for the possible climate between 2001
  and 2025

- `2026-2050-A1FI`: A1FI scenario for the possible climate between 2026
  and 2050

- `2051-2075-A1FI`: A1FI scenario for the possible climate between 2051
  and 2075

- `2076-2100-A1FI`: A1FI scenario for the possible climate between 2076
  and 2100

- `2071-2100_Beck`: Beck scenario for the possible climate between 2071
  and 2100
