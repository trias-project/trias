...
First of all, thanks for considering contributing to trias! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on trias. 😊

trias is an open source project, maintained by people who care. We are
not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://trias-project.github.io/trias/CODE_OF_CONDUCT.md). By
...
Think trias is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using trias for a paper you are writing? Consider [citing
it](https://trias-project.github.io/trias/authors.html).

### Ask a question ⁉️

Using trias and got stuck? Browse the
[documentation](https://trias-project.github.io/trias) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/trias-project/trias/issues/new). While we
...
Have an idea for a new trias feature? Take a look at the
[documentation](https://trias-project.github.io/trias) and [issue
list](https://github.com/trias-project/trias/issues) to see if it isn’t
...
Using trias and discovered a bug? That’s annoying! Don’t let others have
the same experience and report it as an [issue on
GitHub](https://github.com/trias-project/trias/issues/new) so we can fix
...
[This website](https://trias-project.github.io/trias) is generated with
...
issue](https://github.com/trias-project/trias/issues/new) and we can
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/trias-project/trias).
...
Care to fix bugs or implement new functionality for trias? Awesome! 👏
Have a look at the [issue
list](https://github.com/trias-project/trias/issues) and leave a comment
...
1.  Fork [this repo](https://github.com/trias-project/trias) and clone
