...
testthat::test_that("Test plot", {
  ...
  testthat::expect_true(all(class(basic_gam_taxon_key_as_number) == c("gg", "ggplot")))
  testthat::expect_true(all(class(basic_gam_taxon_key_as_string) == c("gg", "ggplot")))
  testthat::expect_true(all(class(basic_gam_taxon_key_and_name) == c("gg", "ggplot")))
