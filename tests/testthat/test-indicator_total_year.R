...
plot_output_without_facets <- 
  indicator_total_year(cleaned_input_test_df,
                       facet_column = NULL)
...
testthat::test_that("Param: x_scale_stepsize", {
  ...
  expect_error(indicator_total_year(input_test_df,
               ...
               paste0("x_major_scale_stepsize should be greater ",
...
testthat::test_that("Test warnings", {
  expect_warning(indicator_total_year(input_test_df),
                 paste0(
                   nrow_no_first_obs,
