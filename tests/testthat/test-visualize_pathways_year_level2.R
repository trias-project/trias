...
input_test_df_other_colnames <-
  input_test_df %>%
  rename(date_introduction = first_observed,
...
testthat::test_that("Argument: df", {
  expect_error(visualize_pathways_year_level2(3,
                                              chosen_pathway_level1 = "escape"),
...
testthat::test_that("Test warning no year of introduction", {
  ...
  paste0(n_first_observed_na_escape,
...
testthat::test_that("test output with other column names", {
  expect_equivalent(output_general_other_colnames$data,
                    output_general$data)
  expect_equivalent(output_general_other_colnames$scales, 
                    output_general$scales)
  expect_equivalent(output_general_other_colnames$mapping,
                    output_general$mapping)
  expect_equivalent(output_general_other_colnames$theme,
                    output_general$theme)
  expect_equivalent(output_general_other_colnames$coordinates,
                    output_general$coordinates)
  expect_equivalent(output_general_other_colnames$facet,
                    output_general$facet)
  expect_equivalent(output_general_other_colnames$labels,
