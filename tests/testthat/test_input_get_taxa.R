...
testthat::test_that("taxon_keys class: character, integer or vector", {
  expect_error(get_taxa(taxon_keys = data.frame()),
...
testthat::test_that("checklist_keys class: character, (character) vector", {
  ...
  expect_error(get_taxa(checklist_keys = 
...
testthat::test_that("taxon_keys not found in GBIF, error from rgbif", {
  expect_error(get_taxa(taxon_keys = 103451),
               "Not Found")
  expect_error(get_taxa(taxon_keys = "103451"),
               "Not Found")
...
testthat::test_that("checklist_keys not found in GBIF, error from rgbif", {
  expect_error(get_taxa(checklist_keys =  "falcon heavy"),
               "Not Found")
  expect_error(get_taxa(checklist_keys = c("e4746398-f7c4-47a1-a474-ae80a4f18e92",
                                           "batman")),
               "Not Found")
})
