...
taxa_test2 <- data.frame(
  ...
  backbone_issues = c(NA_character_),
  checklist_datasetKey = "e4746398-f7c4-47a1-a474-ae80a4f18e92",
  stringsAsFactors = FALSE)

testthat::test_that("taxa column names are correct", {
expect_error(verify_taxa(taxa = taxa_test1, 
                                  verified_taxa = verify_taxa_in),
...
verified_taxa_test1 <- data.frame(
  ...
  bad_backbone_issues_colname = c(NA_character_),
