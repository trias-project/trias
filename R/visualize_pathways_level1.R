...
#' vertebrates/invertebrates) and temporal (lower limit year).
#'
#' @param df df.
...
#'   checked based on CBD standard as returned by `pathways_cbd()` and error is
...
#' @param x_lab NULL or character. Title of the graph. Default: "Pathways".
#' @param y_lab NULL or character. Title of the graph. Default: "Number of
#'   introduced taxa".
#' @return A egg object.
#'
#' @export
...
#' @importFrom dplyr %>% distinct filter mutate rename_at anti_join
...
#' )
#' # All taxa
#' visualize_pathways_level1(t)
#'
#' # Animalia
#' visualize_pathways_level1(t, category = "Animalia")
#'
#' # Chordata
#' visualize_pathways_level1(t, category = "Chordata")
#'
#' # facet phylum
#' visualize_pathways_level1(t, category = "Animalia", facet_column = "phylum")
#'
#' # facet habitat
...
visualize_pathways_level1 <- function(df,
  ...
  # Check values in column with pathways
  pathways_level1_all <- 
    pathways_cbd() %>%
