...
verify_taxa <- function(taxa, taxa_to_verify = NULL) {
  # start checks input
  ...
  if (is.null(taxa_to_verify)) {
    taxa_to_verify <- tibble(
      taxonKey = double(), 
    ...
    class(taxa_to_verify$dateAdded) <- "Date"
  }
